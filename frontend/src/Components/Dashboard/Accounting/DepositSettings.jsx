...
const DepositSettings =(props)=>{ 
    ...
    return (<div style={{
        ...
        alignItems: "center",
        fontFamily:'Carter One',
        fontSize:30, padding:30
      }}>
    Here you will have artist's direct deposit details.<br/>
    You just select the artist from dropdown<br/> and can edit the deposit details.
