    ...
    >
      ...
      >
        ...
        <motion.div onClick={()=>{
            ...
            }} whileHover={{scale:1.2}} className="w3-button w3-large w3-red w3-margin-right w3-round-large">
            confirm
        </motion.div>
        <motion.div onClick={()=>{
            animate(scale,0)
            ...
            }} whileHover={{scale:1.2}} className="w3-button w3-large w3-black w3-round-large">
            cancel
        </motion.div>
      </div>
    </motion.div>
